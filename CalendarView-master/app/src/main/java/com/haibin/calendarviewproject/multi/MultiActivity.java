...
//                mCalendarView.getMultiSelectCalendars();
        ...
        findViewById(R.id.iv_clear).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              mCalendarView.setSelectCalendarRange(2020,2,20,2020,3,12);
                //  mCalendarView.setSelectStartCalendar(2020,2,20);
               // mCalendarView.setMonthView();
                mCalendarView.scrollToCalendar(2020,02,1);
...
//                day == 12 || day == 15 || day == 20 || day == 26;
    ...
    public void onCalendarSelect(Calendar calendar, boolean isClick) {
        Log.e("onDateSelected", " 123 -- " + calendar.getYear() +
                "  --  " + calendar.getMonth() +
                "  -- " + calendar.getDay() +
